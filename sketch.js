      ...
      block2 = Bodies.rectangle(400,400,150,20,plane_options);
       World.add(world,block2)
        ...
        World.add(world,particle2)
         particle3 = Bodies.circle(225,10,10,particle_opitions);
        World.add(world,particl3)
         particle4 = Bodies.circle(230,10,10,particle_opitions);
        World.add(world,particle4)
         particle5 = Bodies.circle(230,10,10,particle_opitions);
...
function draw() {
 ...
 //crie forma para todos os retadores 
